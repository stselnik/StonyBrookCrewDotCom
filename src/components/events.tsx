...
const Events = () => {
    ...
    const events = [
        ...
        {name: "Stony Brook Crew Alumni Day", date: new Date('November 16, 2024'), time:"9:00AM - 1:00PM", location: "Port Jefferson Yacht Club", directions:"2 Pass Way, Port Jefferson, NY 11777", desc: "Calling all Alumni of SBU Crew! Alumni Breakfast Day is being held on Saturday, November 16th, 2024 at the Port Jefferson Yacht Club Clubhouse from 9AM-11:30AM. Enjoy having a tasty meal while catching up with your fellow SBU Crew alumni! Save the date and RSVP by email now: sbu.crew.alumni@gmail.com. We can't wait to see you there!", calendar:""},
        ...
        {name: "The Poughkeespie Regatta", date: new Date('October 5, 2024'), time:"8:00AM", location: "Hudson River Rowing Association", directions: "270 N Water St, Poughkeepsie, NY 12601", desc:"Come experience our first regatta of the fall where we row on the scenic Hudson River.", calendar:""},
