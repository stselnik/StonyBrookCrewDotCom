...
const Events = () => {
    ...
    const events = [
        ...
        {name: "Stony Brook Crew Alumni Day", date: new Date('November 16, 2024'), time:"9:00AM - 1:00PM", location: "Port Jefferson Yacht Club", directions:"2 Pass Way, Port Jefferson, NY 11777", desc: "Calling all Alumni of SBU Crew! Alumni Breakfast Day is being held on Saturday, November 16th, 2024 at the Port Jefferson Yacht Club Clubhouse. Enjoy having a tasty meal while catching up with your fellow SBU Crew alumni! Save the date and RSVP by email now: sbu.crew.alumni@gmail.com. We can't wait to see you there!", calendar:""},
