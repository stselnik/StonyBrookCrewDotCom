    ...
    <Layout>
      ...
      <main className="flex min-h-screen flex-col items-center justify-between bg-[#c84444] pt-16 px-5 lg:px-[8%] text-white">
        ...
        <div className="w-full h-fit overflow-visible">
          <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdsaQBuBJQve6uIJDAInTQdN87wUKjMeFnnI1PNOn0cYrhspg/viewform" className="w-full overflow-visible" width="640" height="2550" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
        </div>
      </main>
    </Layout>
  );
